...
from ..config.cag_config import ConfigManager
from ..ai.models.gemini import GeminiModel
from ..plugins.manager import PluginManager
from ..plugins.base import PluginConfig, PluginError
...
class CAGCoordinator:
    ...
    async def initialize(self):
        ...
        self.model = GeminiModel(
            api_key=self.system_config.models["gemini"].api_key,
            model_name=self.system_config.models["gemini"].model_name
        )
